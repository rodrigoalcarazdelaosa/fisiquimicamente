...
<script type="text/javascript">
	document.addEventListener("adobe_dc_view_sdk.ready", function(){ 
		...
		adobeDCView.previewFile({
			content:{location: {url: "https://fisiquimicament.com/recursos-fisica-quimica/pau-pbau/catalunya/quimica/setembre-2013/setembre-2013-PAU-Quimica.pdf"}},
			metaData:{fileName: "setembre-2013-PAU-Quimica.pdf"}
		}, {embedMode: "IN_LINE"});
	});
</script>