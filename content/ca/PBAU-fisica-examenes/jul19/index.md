...
<script type="text/javascript">
	document.addEventListener("adobe_dc_view_sdk.ready", function(){ 
		...
		adobeDCView.previewFile({
			content:{location: {url: "https://fisiquimicament.com/recursos-fisica-quimica/pau-pbau/illes-balears/fisica/juliol-2019/juliol-2019-PBAU-Fisica.pdf"}},
			metaData:{fileName: "juliol-2019-PBAU-Fisica.pdf"}
		}, {embedMode: "IN_LINE"});
	});
</script>