...
<script type="text/javascript">
	document.addEventListener("adobe_dc_view_sdk.ready", function(){ 
		...
		adobeDCView.previewFile({
			content:{location: {url: "https://fisiquimicament.com/recursos-fisica-quimica/pau-pbau/catalunya/fisica/juny-2019/juny-2019-PAU-Fisica.pdf"}},
			metaData:{fileName: "juny-2019-PAU-Fisica.pdf"}
		}, {embedMode: "IN_LINE"});
	});
</script>