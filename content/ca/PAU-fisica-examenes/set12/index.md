...
<script type="text/javascript">
	document.addEventListener("adobe_dc_view_sdk.ready", function(){ 
		...
		adobeDCView.previewFile({
			content:{location: {url: "https://fisiquimicament.com/recursos-fisica-quimica/pau-pbau/catalunya/fisica/setembre-2012/setembre-2012-PAU-Fisica.pdf"}},
			metaData:{fileName: "setembre-2012-PAU-Fisica.pdf"}
		}, {embedMode: "IN_LINE"});
	});
</script>