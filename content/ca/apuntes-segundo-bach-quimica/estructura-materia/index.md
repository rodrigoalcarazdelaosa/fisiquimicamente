...
L'**equació** de **Rydberg** ens dona la **longitud** d'**ona** de les **línies espectrals** de molts elements químics:
...
on $\mathrm{cte} = k^2e^4m/(2\hbar^2)$ pot escriure's com $\mathrm{cte} = hcR$, sent $R$ la **constant** de **Rydberg**. La **variació** d'**energia** entre dos nivells donats és per tant:
