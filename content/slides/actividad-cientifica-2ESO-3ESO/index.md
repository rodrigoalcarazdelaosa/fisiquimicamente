...
<ul>
<li><strong>qué significa</strong> cada pictograma.</li>
{{% fragment %}}<li>Llevar el pelo recogido.</li>{{% /fragment %}}
{{% fragment %}}<li>Prohibido comer, beber y fumar dentro del laboratorio.</li>{{% /fragment %}}
</ul>

**qué significa** cada pictograma, **qué hacer** en caso de tener que manipular productos químicos con una determinada etiqueta, y **dónde se utiliza** cada pictograma.
