...
En todas las entradas del [<span style="font-variant:small-caps;">**blog**</span>]({{< ref "/post" >}}) así como en los [<span style="font-variant:small-caps;">**apuntes**</span>]({{< ref "/apuntes" >}}) puedes dejarme **comentarios**. Además, desde la sección de [<span style="font-variant:small-caps;">**blog**</span>]({{< ref "/contacto" >}}) puedes escribirme bien utilizando el [formulario]({{< ref "/contacto" >}}), bien escribiéndome directamente un [correo electrónico](mailto:rodri.alcaraz@gmail.com) o bien desde [Twitter](https://twitter.com/alcarazr).
