...
El **Sistema Internacional de Unidades (SI)** sufrió una [revisión](https://www.cem.es/sites/default/files/files/cem_revisionsi_edem_18mayo2018.pdf) a finales de 2018, con la **redefinición** de cuatro de sus siete unidades fundamentales, en concreto el kilogramo (kg), el amperio (A), el kelvin (K) y el mol.
