...
\begin{align*}
	...
	13\thinspace\mathrm{cg} & \cdot \frac{1\thinspace\mathrm g}{10^2\thinspace\mathrm{cg}} \cdot \frac{1\thinspace\mathrm{hg}}{10^2\thinspace\mathrm{g}} = 1.3\times 10^{-3}\thinspace{hg}
\end{align*}
