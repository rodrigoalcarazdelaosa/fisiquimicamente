...
\begin{align*}
	...
	3\thinspace\cancel{\mathrm{dam^2}} & \cdot \frac{1\thinspace\cancel{\mathrm{m^2}}}{10^2\thinspace\cancel{\mathrm{cg}}} \cdot \frac{1\thinspace\mathrm{hg}}{10^2\thinspace\cancel{\mathrm{g}}} = 1.3\times 10^{-3}\thinspace\mathrm{hg}
\end{align*}
