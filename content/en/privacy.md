...
- [<img draggable="false" class="icon" alt="fontawesome" src="/icon/fontawesome.svg"> FontAwesome](https://fontawesome.com/privacy) for icons.
- [<img draggable="false" class="icon" alt="paypal" src="/icon/paypal.svg"> Paypal](https://www.paypal.com/es/webapps/mpp/ua/privacy-full) for the *coffees* (donations).
