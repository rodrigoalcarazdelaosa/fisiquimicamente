...
subtitle: Naturaleza y propagación de la luz, óptica geométrica, el ojo y los defectos de la visión e instrumentos ópticos
summary: "<code style='color: #2E3440;background:#88C0D0'>NOVEDAD</code><br>Naturaleza y propagación de la luz, óptica geométrica, el ojo y los defectos de la visión e instrumentos ópticos."
...
con  $L = \sum_i{l_in_i}$ (camino óptico). Si el medio no fuera homogéneo, los sumatorios se reemplazarían por integrales. A la vista de lo anterior, puede reformularse el principio de Fermat:
