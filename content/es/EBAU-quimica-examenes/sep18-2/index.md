...
url: "recursos-fisica-quimica/ebau/quimica/examenes-completos/septiembre-2018-2"
subtitle: Opción 2
summary: Opción 2.
...
<script type="text/javascript">
	document.addEventListener("adobe_dc_view_sdk.ready", function(){ 
		...
		adobeDCView.previewFile({
			content:{location: {url: "https://fisiquimicamente.com/recursos-fisica-quimica/ebau/quimica/examenes-completos/septiembre-2018-2/septiembre-2018-2-EBAU-Quimica.pdf"}},
			metaData:{fileName: "septiembre-2018-2-EBAU-Quimica.pdf"}
		}, {embedMode: "IN_LINE"});
	});
</script>