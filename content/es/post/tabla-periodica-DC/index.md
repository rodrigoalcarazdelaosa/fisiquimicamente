...
{{% alert note %}}
Si te gustan estas **Tablas Periódicas *especiales***, echa un vistazo a las versiones con [**científicos**]({{< ref "/post/tabla-periodica-cientificos/index.md" >}}), personajes de [<svg xmlns="http://www.w3.org/2000/svg" width="700"  height="294.4" viewBox="0 0 700.00001 294.42258">
...
</svg>](https://kitchapman.co.uk/a-disney-periodic-table/), de [**Astérix**](http://www.ndietrich.com/archives/950) o de [**Los Simpsons**](http://www.ndietrich.com/archives/955).
{{% /alert %}}