...
{{% alert note %}}
Pinchando en el botón de arriba puedes descargarte un **PDF** donde cada imagen es un **enlace** que te lleva a una página web del personaje. Además, por detrás (segunda página del PDF) puedes ver tanto el **nombre** de cada elemento (enlazado a {{< icon name="wikipedia-w" pack="fab" >}}Wikipedia) como el de cada personaje (también enlazado a la misma página web).
{{% /alert %}}