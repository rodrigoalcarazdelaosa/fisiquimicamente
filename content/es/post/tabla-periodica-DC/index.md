...
{{% alert note %}}
Si te gustan estas Tablas Periódicas *especiales*, echa un vistazo a las versiones con [**científicos**]({{< ref "/post/tabla-periodica-cientificos/index.md" >}}), personajes de [**Disney**](https://kitchapman.co.uk/a-disney-periodic-table/), de [**Astérix**](http://www.ndietrich.com/archives/950) o de [**Los Simpsons**](http://www.ndietrich.com/archives/955).
{{% /alert %}}