...
de donde se obtiene $C_\text{b\&n}^\text{máx} = \sqrt{21} \approx 4.58$, que corresponde con este color <strong>fucsia</strong> aproximadamente:

<svg width="100%" height="164px">
  <rect width="300" height="100" style="fill:#2a54a9" />
</svg>