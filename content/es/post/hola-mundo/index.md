...
En la **esquina inferior derecha** puedes ver este **icono** <img draggable="false" class="icon" alt="tawk" src="/icon/tawk.svg">. Pinchando en él puedes iniciar un **chat en directo** conmigo tras introducir tu nombre (el correo electrónico es opcional, solo si deseas que pueda contactarte en caso de no coincidir en el chat).
