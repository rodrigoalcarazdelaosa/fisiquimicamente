...
### Chat de grupo
En la **esquina inferior izquierda** puedes ver este **icono** <img draggable="false" class="icon" alt="now4real" src="/icon/now4real.svg">. El número indica cuántas personas están navegando por la web en ese momento y pinchando puedes comenzar a escribir en un **chat** de **grupo** tras iniciar sesión (Google, Facebook, Twitter o LinkedIn).
