...
{{< figure library="true" src="reacciones-quimicas-2ESO-3ESO/combustion-metano-intro.svg" title="Una molécula de metano (\ch{CH4}) reacciona con dos moléculas de oxígeno (\ch{O2}) para producir una molécula de dióxido de carbono (\ch{CO2}) y dos moléculas de agua (\ch{H2O})." lightbox="false" width="100%" >}}
