...
{{< figure src="como-se-evalua.svg" title="La evaluación debe tener un **carácter continuo**." lightbox="false" width="100%" >}}
...
{{< figure src="evaluacion-formadora.svg" title="**Evaluación formadora**" lightbox="false" width="100%" >}}
...
- [Evaluación inicial](#/6/23)
- [Evaluación procesual](#/6/25)
- [Evaluación final](#/6/28)
...
{{< figure src="sintaxis-criterios.svg" lightbox="false" width="100%" >}}

---

{{< figure src="procedimientos-actividades-instrumentos.svg" lightbox="false" width="100%" >}}

---

{{< figure src="procedimientos-actividades-instrumentos-ejemplos.svg" title="Encuentra ejemplos de cada instrumento [aquí](https://www.educantabria.es/documents/39930/11206926/orientaciones+para+la+evaluación+.+Anexo+I-1_ExtractoGuia_Portada.pdf/bde9fd4a-db1a-d1e6-15a6-34b386b1d573?t=1689765493436)." lightbox="false" width="60%" >}}
...
- Si los resultados son satisfactorios para el alumnado (superan un 90&thinsp;% de aprobados, por ejemplo).
...
- [Orientaciones para la elaboración de situaciones de aprendizaje](#/7/2)
- [Tabla modelo para el diseño de una situación de aprendizaje](#/7/18)
...
{{< figure src="situaciones-aprendizaje.svg" lightbox="false" width="50%" >}}

---

### Orientaciones para la elaboración de situaciones de aprendizaje
...
- [Datos identificativos](#/7/7)
- [Conexión con los elementos curriculares](#/7/8)
- [Metodología](#/7/9)
- [Secuenciación de actividades o procesos](#/7/12)
- [Evaluación](#/7/15)
...
<div align="center">
{{% lottie src="graficas.tgs" width="50%" %}}
</div>
...
{{< figure src="tabla-modelo-situacion-aprendizaje.svg" title="Descárgala [aquí](https://www.educantabria.es/documents/39930/11206926/TABLA+PARA+EL+DISEÑO+DE+UNA+SITUACIÓN+DE+APRENDIZAJE.docx/39d73a80-648d-9aac-15f5-2823003e733d?t=1663745046450)." lightbox="false" width="35%" >}}

---

#### Situación de aprendizaje de Tecnología (3.º ESO)

{{< figure src="situacion-aprendizaje-3eso-datos-identificativos.svg" lightbox="false" width="90%" >}}

---

{{< figure src="situacion-aprendizaje-3eso-conexion-elementos-curriculares-1.svg" lightbox="false" width="55%" >}}

---

{{< figure src="situacion-aprendizaje-3eso-conexion-elementos-curriculares-2.svg" lightbox="false" width="50%" >}}

---

{{< figure src="situacion-aprendizaje-3eso-metodologia.svg" lightbox="false" width="100%" >}}

---

{{< figure src="situacion-aprendizaje-3eso-secuenciacion.svg" lightbox="false" width="100%" >}}

---

{{< figure src="situacion-aprendizaje-3eso-evaluacion.svg" lightbox="false" width="100%" >}}

---

{{< figure src="situacion-aprendizaje-3eso-anexos.svg" lightbox="false" width="100%" >}}
