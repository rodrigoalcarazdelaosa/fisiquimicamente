...
{{< figure library="true" src="materia-2ESO-3ESO/destilacion.svg" title="Imagen de [OpenClipart-Vectors](https://pixabay.com/es/users/openclipart-vectors-30363/) en [Pixabay](https://pixabay.com/es/)." lightbox="false" width=65% >}}
