...
- [Efectos del calor en los cuerpos](#/3/11)
...
Cuando dos cuerpos se ponen en **contacto térmico**, el que está a mayor temperatura cede calor (enfriándose) al que está a menor temperatura (calentándose), llegando al cabo de un tiempo a un **equilibrio térmico** (misma temperatura).
...
Al variar la temperatura de un cuerpo, éste puede [**cambiar** su **estado** de agregación]({{< ref "/slides/materia-2ESO-3ESO/index.md/#/3/5" >}}).
...
### Renovables 🍃
{{< figure library="true" src="energia-2ESO-3ESO/energias-renovables.svg" title="Logotipo para las energías renovables de la diseñadora gráfica y directora de arte alemana Melanie Maecker-Tursun de Hamburgo." lightbox="false" width="40%" >}}
...
{{< figure library="true" src="energia-2ESO-3ESO/biomasa.jpg" lightbox="false" width="50%" >}}
...
{{< figure library="true" src="energia-2ESO-3ESO/molino-mareas.jpg" title="[Molino de mareas de Santa Olaja](https://es.wikipedia.org/wiki/Molino_de_Santa_Olaja)." lightbox="false" width="80%" >}}

---

{{< figure library="true" src="energia-2ESO-3ESO/olas.jpg" title="Energía *undimotriz*. [**Roger Mosley**](https://pixabay.com/es/photos/ola-el-agua-mar-oc%C3%A9ano-pac%C3%ADfico-2089959/)." lightbox="false" width="90%" >}}
