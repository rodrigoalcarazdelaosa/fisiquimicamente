...
$$
V = \frac{nRT}{p} = \frac{0.9\thinspace\mathrm{mol} \cdot 0.082\thinspace\frac{\mathrm{atm}\mathrm L}{\mathrm{mol K}}\cdot 298\thinspace\mathrm K}{\SI{0.98}{\atm}} = \SI{22.4}{\liter\of{\ce{H2}}}
$$	
{{% /alert %}}		