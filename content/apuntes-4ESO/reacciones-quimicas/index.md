...
$$
V = \frac{nRT}{p} = \frac{0.9\thinspace\mathrm{mol} \cdot 0.082\thinspace\frac{\mathrm{atm\thinspace L}}{\mathrm{mol\thinspace K}}\cdot 298\thinspace\mathrm K}{0.98\thinspace\mathrm{atm}} = 22.4\thinspace\mathrm{L_\ce{H2}}
$$	
{{% /alert %}}		