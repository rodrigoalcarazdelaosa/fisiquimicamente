...
$$
\omega = 90\thinspace\mathrm{rpm} = 90\frac{\cancel{\mathrm{rev}}}{\cancel{\mathrm{min}}} \cdot \frac{\SI{2\pi}{\radian}}{\SI{1}{\cancel\rev}} \cdot \frac{\SI{1}{\cancel\minute}}{\SI{60}{\s}} = \SI{3\pi}{\radian/\s} \approx \SI{9.4}{\radian/\s}
$$
