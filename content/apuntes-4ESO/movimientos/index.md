...
{\color{TOL_blue}\begin{align*}
	\text{\textsc{coche} (MRUV): } x_\mathrm c &= x_{0\mathrm c} + v_{0\mathrm c}(t-t_{0\mathrm c})+\frac{1}{2}a_\mathrm c(t-t_{0\mathrm c})^2 \\
	\text{\textsc{tren} (MRU): } x_\mathrm t &= x_{0\mathrm t} + v_\mathrm t(t-t_{0\mathrm t})
\end{align*}}
