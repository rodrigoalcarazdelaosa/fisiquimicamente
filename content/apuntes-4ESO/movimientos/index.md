...
$$
v_0 = 70.2\thinspace\frac{\cancel{\mathrm{km}}}{\cancel{\mathrm{h}}}\cdot \frac{1000\thinspace\mathrm m}{\SI{1}{\cancel\km}} \cdot \frac{\SI{1}{\cancel\hour}}{\SI{3600}{\s}} = \SI{19.5}{\m/\s}
$$
